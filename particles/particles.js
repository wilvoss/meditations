...
function GetMouseXY(a) {
  ...
  tempX = a.clientX;
  tempY = a.clientY;
  if (tempX == undefined) tempX = 150;
  if (tempY == undefined) tempY = 200;
...
function FlipOptions() {
  ...
  if (showOptions) keyCommands.style.display = 'block';
  else keyCommands.style.display = 'none';
}
function StartMagic() {
  wandDiv = Create('div');
      ...
      var h,
        ...
        MoveMe = function () {
          ...
          if (useGPU) {
            ...
            element.style.transform = 'translate(' + driftAmount + 'px,' + c + ')';
          } else {
